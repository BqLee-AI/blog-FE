    ...
    <div className="animate-fade-in max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 md:py-12">
      <header className="mb-12 space-y-10">
        <div className="relative group">
          {/* 装饰性背景 */}
          <div className="absolute -inset-4 bg-gradient-to-r from-blue-500/5 via-indigo-500/5 to-purple-500/5 rounded-[3rem] blur-2xl opacity-50 transition duration-1000" />
          
          <div className="relative flex flex-col lg:flex-row gap-8 lg:items-center">
            <div className="flex-1 space-y-4">
              <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-blue-50/50 dark:bg-blue-900/20 border border-blue-100/30 dark:border-blue-800/30">
        ...
        <nav className="sticky top-4 z-50 py-2.5 px-3 rounded-2xl bg-white/70 dark:bg-slate-900/70 backdrop-blur-xl border border-white/50 dark:border-white/5 shadow-xl shadow-blue-500/5">
