      ...
      <div className="relative w-full max-w-[420px] bg-white/90 dark:bg-slate-900/90 rounded-[2.5rem] shadow-2xl overflow-hidden border border-white/40 dark:border-white/5 backdrop-blur-2xl animate-in zoom-in-95 duration-300">
        ...
        <div className="relative pt-8 pb-6 px-8 text-center overflow-hidden">
          ...
          <div className="relative z-10 space-y-2">
            <div className="inline-flex items-center justify-center w-12 h-12 bg-gradient-to-br from-blue-500 to-indigo-600 rounded-2xl shadow-lg shadow-blue-500/20 mb-1">
        ...
        {/* 登录标签页 */}
        {activeTab === "login" && (
          <div className="p-6 pb-8 space-y-4 animate-in slide-in-from-bottom-2 duration-500">
            {error && (
              <div className="flex items-center gap-3 p-3 text-[11px] font-bold text-red-500 bg-red-500/10 border border-red-500/20 rounded-xl">
            ...
            <form onSubmit={handleLoginSubmit} className="space-y-4">
              ...
              <div className="pt-2">
                <button
                  type="submit"
                  disabled={isLoading}
                  className="w-full h-11 bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 text-white rounded-xl font-black text-sm shadow-lg shadow-blue-500/20 active:scale-[0.98] transition-all disabled:opacity-50"
                >
                  {isLoading ? "认证中..." : "登录平台"}
                </button>
              </div>
        ...
        {/* 注册标签页 - 极致压缩高度 */}
        {activeTab === "register" && (
          <div className="p-6 pb-8 space-y-3.5 animate-in slide-in-from-bottom-2 duration-500 max-h-[60vh] overflow-y-auto no-scrollbar">
            {error && (
              <div className="flex items-center gap-3 p-3 text-[11px] font-bold text-red-500 bg-red-500/10 border border-red-500/20 rounded-xl">
            ...
            <form onSubmit={handleRegisterSubmit} className="space-y-3">
              ...
              <div className="flex gap-2">
                ...
                <button
                  ...
                  className="px-4 py-2.5 bg-blue-500 hover:bg-blue-600 text-white rounded-xl text-[11px] font-black transition-all disabled:opacity-50"
                >
              ...
              <div className="pt-2">
                <button
                  type="submit"
                  disabled={isLoading}
                  className="w-full h-11 bg-gradient-to-r from-green-600 to-emerald-600 hover:from-green-700 hover:to-emerald-700 text-white rounded-xl font-black text-sm shadow-md shadow-green-500/10 active:scale-[0.98] transition-all disabled:opacity-50"
                >
                  {isLoading ? "加入中..." : "立即注册"}
                </button>
              </div>
